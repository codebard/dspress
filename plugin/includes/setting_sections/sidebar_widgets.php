...
<h1>Sidebar Widget Styles</h1>
			...
			<br><br>
			Left <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][insert_text_align]" value="left"<?php echo esc_html( $widget_insert_text_align_checked_left ); ?>>
			Center <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][insert_text_align]" value="center"<?php echo esc_html( $widget_insert_text_align_checked_center ); ?>>
			Right <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][insert_text_align]" value="right"<?php echo esc_html( $widget_insert_text_align_checked_right ); ?>>
		...
		<h3>Widget Message Font Size</h3>
			...
			<input type="text" name="opt[<?php echo esc_attr( $tab ); ?>][message_font_size]" value="<?php echo esc_html( $this->opt[$tab]['message_font_size'] ); ?>">
			...
			Yes <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][hide_site_widget_on_single_post_page]" value="yes"<?php echo esc_html( $hide_site_widget_on_single_post_page_checked_yes ); ?>>
			No <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][hide_site_widget_on_single_post_page]" value="no"<?php echo esc_html( $hide_site_widget_on_single_post_page_checked_no ); ?>>
