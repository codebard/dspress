...
?>
			...
			<input id="cb_p8_button_color" class="cb_p8-color-picker" name="opt[<?php echo esc_attr( $tab ); ?>][button_color]" type="text" value="<?php echo esc_html( $this->opt[$tab]['button_color'] ); ?>" /><br><br>
			...
			<input id="cb_p8_button_color" class="cb_p8-color-picker" name="opt[<?php echo esc_attr( $tab ); ?>][button_hover_color]" type="text" value="<?php echo esc_html( $this->opt[$tab]['button_color'] ); ?>" /><br><br>
			...
			<input id="cb_p8_button_color" class="cb_p8-color-picker" name="opt[<?php echo esc_attr( $tab ); ?>][button_text_color]" type="text" value="<?php echo esc_html( $this->opt[$tab]['button_text_color'] ); ?>" /><br><br>
			...
			<br><br>
			Buy buttons <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][button_type]" value="buy_button"<?php echo esc_html( $buy_button_checked ); ?>>
			Follow buttons <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][button_type]" value="follow_button"<?php echo esc_html( $follow_button_checked ); ?>>
			<br><br>
			...
			Yes <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][force_profile_link]" value="yes"<?php echo esc_html( $force_profile_checked_yes ); ?>>
			No <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][force_profile_link]" value="no"<?php echo esc_html( $force_profile_checked_no ); ?>>
			<br><br>
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][open_new_window]" value="yes"<?php echo esc_html( $open_new_window_checked_yes ); ?>>
			No <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][open_new_window]" value="no"<?php echo esc_html( $open_new_window_checked_no ); ?>>
			<br><br>		
			...
			<br><br>
			Yes <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][force_site_button]" value="yes"<?php echo esc_html( $force_site_checked_yes ); ?>>
			No <input type="radio" name="opt[<?php echo esc_attr( $tab ); ?>][force_site_button]" value="no"<?php echo esc_html( $force_site_checked_no ); ?>>
			<br><br>
			...
			<br><br>			
			 <input class="cb_p8_file_upload" type="text" id="opt[<?php echo esc_attr( $tab ); ?>]_custom_button" size="36" name="opt[<?php echo esc_attr( $tab ); ?>][custom_button]" value="<?php echo esc_html( $this->opt[$tab]['custom_button'] ); ?>" /> <a href="" class="cb_p8_clear_prevfield">Clear</a>
		<br><br>
		...
		<?php
			...
			{
				echo '<a rel="nofollow"'. esc_html( @$new_window ).' href="'. esc_html( @$url ).'"><img style="margin-top: '. esc_html( $this->opt['sidebar_widgets']['button_margin'] ).';margin-bottom: '. esc_html( $this->opt['sidebar_widgets']['button_margin'] ).';max-width:50px;width:100%;height:auto;" src="'. esc_html( $this->opt[$tab]['custom_button'] ).'"></a>';
		...
		?>
			...
			<br><br>
			<input type="text" style="width : 50px" name="opt[<?php echo esc_attr( $tab ); ?>][custom_button_width]" value="<?php echo esc_html( $this->opt[$tab]['custom_button_width'] ); ?>">
