<?php 
	...
	<div class="cb_p8_setup_wizard_two_col" style="max-width : 600px;">
		...
		<div class="cb_p8_setup_wizard_col_33" style="text-align : center;">
			...
			<button class="cb_p8_admin_button" onclick="window.open('<?php echo $this->lang['newsletter_link'] ?>');" target="_blank"><?php echo $this->lang['setup_wizard_join_mailing_list_link_label'];?></button>
		</div>
